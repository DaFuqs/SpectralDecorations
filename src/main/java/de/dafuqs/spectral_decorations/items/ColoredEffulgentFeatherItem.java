...
public class ColoredEffulgentFeatherItem extends CloakedItem {
	...
	public static final ResourceLocation CLOAK_ADVANCEMENT = SpectralDecorations.locate("pluck_colored_effulgent_feather");

	private static final Map<DyeColor, ColoredEffulgentFeatherItem> FEATHERS = Maps.newEnumMap(DyeColor.class);
	protected final DyeColor color;
	
	public ColoredEffulgentFeatherItem(Properties settings, DyeColor color) {
