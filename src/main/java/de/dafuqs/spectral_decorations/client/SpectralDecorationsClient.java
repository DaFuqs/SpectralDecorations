...
public class SpectralDecorationsClient implements ClientModInitializer {
	...
	public void onInitializeClient() {
		...
		modContainer.ifPresent(container -> ResourceManagerHelper.registerBuiltinResourcePack(SpectralDecorations.locate("spectral_decorations"), container, "Spectral Decorations Overrides", ResourcePackActivationType.DEFAULT_ENABLED));
	}
