...
public class SpectralDecorationsBlocks {
	...
	public static void register(IEventBus modBus) {
		...
		for (DyeColor color : SpectrumColorHelper.VANILLA_DYE_COLORS) {
			...
			registerBlockWithItem(ItemGroupIDs.SUBTAB_DECORATION, colorString + "_resplendent_block", () -> new CushionedDirectionalBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.RED_WOOL).mapColor(color)), new Item.Properties().rarity(Rarity.UNCOMMON), Type.RESPLENDENT_BLOCK);
		...
		registerBlockWithItem(ItemGroupIDs.SUBTAB_DECORATION, "copper_tubing", () -> new WeatheringCopperRotatedPillarBlock(WeatheringCopper.WeatherState.UNAFFECTED, BlockBehaviour.Properties.ofFullCopy(Blocks.COPPER_BLOCK)), new Item.Properties(), Type.TUBING);
		registerBlockWithItem(ItemGroupIDs.SUBTAB_DECORATION, "exposed_copper_tubing", () -> new WeatheringCopperRotatedPillarBlock(WeatheringCopper.WeatherState.EXPOSED, BlockBehaviour.Properties.ofFullCopy(Blocks.EXPOSED_COPPER)), new Item.Properties(), Type.TUBING);
		registerBlockWithItem(ItemGroupIDs.SUBTAB_DECORATION, "weathered_copper_tubing", () -> new WeatheringCopperRotatedPillarBlock(WeatheringCopper.WeatherState.WEATHERED, BlockBehaviour.Properties.ofFullCopy(Blocks.WEATHERED_COPPER)), new Item.Properties(), Type.TUBING);
		registerBlockWithItem(ItemGroupIDs.SUBTAB_DECORATION, "oxidized_copper_tubing", () -> new WeatheringCopperRotatedPillarBlock(WeatheringCopper.WeatherState.OXIDIZED, BlockBehaviour.Properties.ofFullCopy(Blocks.OXIDIZED_COPPER)), new Item.Properties(), Type.TUBING);
