...
public class SpectralDecorationsKindlingVariants {
	...
	public static void register() {
		for (DyeColor color : DyeColor.values()) {
			...
			COLORED_VARIANTS.put(color, KindlingVariant.register(s, "textures/entity/kindling/" + s + ".png", "textures/entity/kindling/" + s + "_blinking.png", "textures/entity/kindling/" + s + "_angry.png",
					"textures/entity/kindling/" + s + "_clipped.png", "textures/entity/kindling/" + s + "_blinking_clipped.png", "textures/entity/kindling/" + s + "_angry_clipped.png"));
		}
	}
